<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1><?=!empty($data)?'Edit':'Tambah'?> Simpanan Pokok</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="<?=base_url('dashboard')?>">Dashboard</a></div>
        <div class="breadcrumb-item">Simpanan</div>
        <div class="breadcrumb-item">Pokok</div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
            ...
            <div class="card-body row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" name="simpanan_jumlah" value="100000" readonly required class="form-control" placeholder="Masukan jumlah setoran" >
                </div>
              </div>
